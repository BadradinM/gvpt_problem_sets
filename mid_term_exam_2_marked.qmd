...
::: callout-tip
You need to subtract the intersection ({5,5}) to avoid double counting it.
:::
...
::: callout-tip
You need to use the t-statistic.
:::

This is a differnces of mean, use t-stat
...
::: callout-tip
You needed to remove those who were not eligible to vote.
:::
...
::: callout-tip
The degrees of freedom are calculated by subtracting one from the smaller of the two groups' sample sizes.
:::
