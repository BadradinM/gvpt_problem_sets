...
stargazer(m, 
          type = "text", 
          covariate.labels = c("Education Expend (%)", "Intercept"),
...
stargazer(model, 
          type = "text", 
          covariate.labels = c("Education Expend (%)", "Level of Democracy", "Intercept"),
          dep.var.labels = c("Literacy Rate"),
          ci = TRUE,  
          ci.level = 0.95)
```
...
```{r}
all <- lm(literacy ~ dem_score14 + spendeduc + gdp_10_thou + educ_quality + ungr9095, data = world_data)
print(all)
stargazer(all, 
          type = "text", 
          covariate.labels = c("Level of Democracy", "Education Expend", "GDP", "Education Quality", "Avg Annual Pop"),
          dep.var.labels = c("Literacy Rate"),
          ci = TRUE,  
          ci.level = 0.95)
```
