...
there is 1/4 (25%) probability that the next two dice will both be greather that three
...
P (smokers/develop lunch cancer) = 0.60

P (develop lung/do not smoke pack) = 0.10

P (smoke a pack) = P (smokers) x P(smokers/develop lunch cancer) = 0.15 x 0.60 = 0.09
